...
#Bg Image
new = ImageTk.PhotoImage(Image.open('E:\weather\HomeScreen.jpeg'))
...
def city_name():
    #API call
    api_key='1b9c647259ef652461cdabeca42ba135'
    ...
    if(id==800):
            new1 = ImageTk.PhotoImage(Image.open('E:\weather\ClearSky.jpeg'))
    elif(id>=801 and id<=804):
            new1 = ImageTk.PhotoImage(Image.open('E:\weather\Cloudy.jpeg'))
    elif(id>=300 and id<=321) or (id>=500 and id<=531):
            new1 = ImageTk.PhotoImage(Image.open('E:\weather\Rain.jpeg'))
    elif(id>=200 and id<=232):
            new1 = ImageTk.PhotoImage(Image.open('E:\weather\Thunder.jpeg'))
    elif(id>=600 and id<=622):
            new1 = ImageTk.PhotoImage(Image.open('E:\weather\snow.jpeg'))
    elif(id>=701 and id<=781):
            new1 = ImageTk.PhotoImage(Image.open('E:\weather\Mist.jpeg'))
    else:
        new1 = new   
